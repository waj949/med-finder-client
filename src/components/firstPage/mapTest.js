...
class ReactGoogleMaps extends Component {
  ...
  render() {
    return (
    <div className="animated fadeIn" style={{ height: "75vh", width: "80%", margin: "auto" }}>
      <Card>
        ...
        <CardBody>
          <GoogleMapsComponent
            key="map"
            googleMapURL={`https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=${process.env.REACT_APP_GOOGLE_MAP_API_KEY2}`}
